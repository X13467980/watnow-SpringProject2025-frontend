...
const MuscleGroupsAccordion = () => {
  ...
  return (
    <div className="bg-[#B31717] min-h-screen p-8">
      {groups.map((group, groupIndex) => (
        <div key={groupIndex} className="mb-8">
          <div className="flex items-center mb-6">
            <div className="w-2 h-12 bg-white rounded-full mr-4"></div>
          ...
          <div className="space-y-4">
            {group.exercises.map((exercise, exerciseIndex) => (
              <div
                key={exerciseIndex}
                className="flex items-center backdrop-blur-sm border-4 border-white rounded-full"
              >
